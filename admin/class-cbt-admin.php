...
class CBT_Admin
{
    ...
    {
        CBT_Admin_Results_Service::init();
        ...
        add_action('admin_post_cbt_start_login_readiness_warm_queue', [CBT_Admin_Exams_Actions::class, 'handle_start_login_readiness_warm_queue']);
        add_action('admin_post_cbt_stop_login_readiness_warm_queue', [CBT_Admin_Exams_Actions::class, 'handle_stop_login_readiness_warm_queue']);
        ...
        add_action('admin_post_cbt_finalize_adaptive_load_expired_attempts', [CBT_Admin_Exams_Actions::class, 'handle_finalize_adaptive_load_expired_attempts']);
        ...
        add_action('admin_post_cbt_clear_test_artifacts', [CBT_Admin_Test_Hub_Actions::class, 'handle_clear_test_artifacts']);
        add_action('admin_post_cbt_save_test_hub_settings', [CBT_Admin_Test_Hub_Actions::class, 'handle_save_settings']);
        add_action('admin_post_cbt_refresh_test_hub_health', [CBT_Admin_Test_Hub_Actions::class, 'handle_refresh_runner_health']);
        add_action('admin_post_cbt_check_test_hub_e2e_readiness', [CBT_Admin_Test_Hub_Actions::class, 'handle_check_e2e_readiness']);
        add_action('admin_post_cbt_queue_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_queue_flow_check_job']);
        add_action('admin_post_cbt_retry_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_retry_flow_check_job']);
        add_action('admin_post_cbt_cancel_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_cancel_flow_check_job']);
        add_action('admin_post_cbt_clear_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_clear_flow_check_job']);
        add_action('admin_post_cbt_repair_stuck_flow_check_jobs', [CBT_Admin_Test_Hub_Actions::class, 'handle_repair_stuck_flow_check_jobs']);
        add_action('admin_post_cbt_download_test_hub_artifact', [CBT_Admin_Test_Hub_Actions::class, 'handle_download_test_hub_artifact']);
        add_action('wp_ajax_cbt_run_all_unit_tests', [CBT_Admin_Test_Hub_Actions::class, 'handle_run_all_unit_tests']);
        add_action('wp_ajax_cbt_clear_test_artifacts', [CBT_Admin_Test_Hub_Actions::class, 'handle_clear_test_artifacts']);
        add_action('wp_ajax_cbt_save_test_hub_settings', [CBT_Admin_Test_Hub_Actions::class, 'handle_save_settings']);
        add_action('wp_ajax_cbt_refresh_test_hub_health', [CBT_Admin_Test_Hub_Actions::class, 'handle_refresh_runner_health']);
        add_action('wp_ajax_cbt_check_test_hub_e2e_readiness', [CBT_Admin_Test_Hub_Actions::class, 'handle_check_e2e_readiness']);
        add_action('wp_ajax_cbt_queue_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_queue_flow_check_job']);
        add_action('wp_ajax_cbt_retry_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_retry_flow_check_job']);
        add_action('wp_ajax_cbt_cancel_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_cancel_flow_check_job']);
        add_action('wp_ajax_cbt_clear_flow_check_job', [CBT_Admin_Test_Hub_Actions::class, 'handle_clear_flow_check_job']);
        add_action('wp_ajax_cbt_repair_stuck_flow_check_jobs', [CBT_Admin_Test_Hub_Actions::class, 'handle_repair_stuck_flow_check_jobs']);
        ...
        add_action('wp_ajax_cbt_reset_database', [CBT_Admin_Maintenance_Actions::class, 'handle_reset_database']);
        add_action('wp_ajax_cbt_generate_test_dataset', [CBT_Admin_Maintenance_Actions::class, 'handle_generate_test_dataset']);
        add_action('admin_post_cbt_run_unit_test_suite', [CBT_Admin_Test_Hub_Actions::class, 'handle_run_unit_test_suite']);
        add_action('wp_ajax_cbt_run_unit_test_suite', [CBT_Admin_Test_Hub_Actions::class, 'handle_run_unit_test_suite']);
        ...
        add_action('wp_ajax_cbt_start_load_test', [CBT_Admin_Maintenance_Actions::class, 'handle_start_load_test']);
        add_action('wp_ajax_cbt_cancel_load_test', [CBT_Admin_Maintenance_Actions::class, 'handle_cancel_load_test']);
        add_action('wp_ajax_cbt_delete_load_test_job', [CBT_Admin_Maintenance_Actions::class, 'handle_delete_load_test_job']);
        add_action('wp_ajax_cbt_clear_load_test_jobs', [CBT_Admin_Maintenance_Actions::class, 'handle_clear_load_test_jobs']);
        ...
        add_action('admin_post_cbt_download_question_template_word_matching', [CBT_Admin_Questions_Actions::class, 'handle_download_question_template_word_matching']);
        add_action('admin_post_cbt_download_question_template_word_cloze', [CBT_Admin_Questions_Actions::class, 'handle_download_question_template_word_cloze']);
        add_action('admin_post_cbt_download_question_template_word_categorization', [CBT_Admin_Questions_Actions::class, 'handle_download_question_template_word_categorization']);
        add_action('admin_post_cbt_download_question_template_word_table_completion', [CBT_Admin_Questions_Actions::class, 'handle_download_question_template_word_table_completion']);
        ...
        add_action('wp_ajax_cbt_results_essay_ai_start', [CBT_Admin_Results_Actions::class, 'handle_essay_ai_start_ajax']);
        add_action('wp_ajax_cbt_results_essay_ai_tick', [CBT_Admin_Results_Actions::class, 'handle_essay_ai_tick_ajax']);
        add_action('wp_ajax_cbt_results_essay_ai_stop', [CBT_Admin_Results_Actions::class, 'handle_essay_ai_stop_ajax']);
        add_action('wp_ajax_cbt_results_essay_ai_models', [CBT_Admin_Results_Actions::class, 'handle_essay_ai_models_ajax']);
    ...
    private static function cbt_data_tables(wpdb $wpdb): array
    {
        ...
        return [
            ...
            $prefix . 'cbt_question_table_completion_cell_options',
            $prefix . 'cbt_question_table_completion_cells',
            $prefix . 'cbt_question_table_completion',
            $prefix . 'cbt_question_categorization_items',
            $prefix . 'cbt_question_categorization',
            $prefix . 'cbt_question_cloze_dropdown_options',
            $prefix . 'cbt_question_cloze_dropdown_blanks',
            $prefix . 'cbt_question_cloze_dropdown',
            $prefix . 'cbt_question_matching_items',
            $prefix . 'cbt_question_matching',
            $prefix . 'cbt_question_ordering_items',
            $prefix . 'cbt_question_ordering',
